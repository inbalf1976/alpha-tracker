...
with st.sidebar:
    ...
    # PROTECTED: Bootstrap All Models
    ...
    # PROTECTED: Daemon Start/Stop
    col1, col2 = st.columns(2)
    with col1:
        if st.button("▶️ Start", use_container_width=True, key="daemon_start"):
            if require_local_access("Start Learning Daemon"):
                try:
    ...
    with col2:
        if st.button("⏹️ Stop", use_container_width=True, key="daemon_stop"):
            if require_local_access("Stop Learning Daemon"):
                try:
